...
const INSTALL_CODE = `npm install @stackline/react-highcharts@17.0.0 highcharts@12.6.0 --save-exact`;
      ...
      <main className="shell">
        <header>
          <div className="header-copy">
            ...
            <h1>@stackline/react-highcharts 17.0.0</h1>
            <p>Project generated with the React 17 Vite blueprint and running the maintained React 17 package line.</p>
          </div>
    ...
    <main className="shell">
      <header>
        <div className="header-copy">
          ...
          <h1>@stackline/react-highcharts 17.0.0</h1>
          <p>
            React 17 wrapper line for Highcharts, StockChart, modules, event callbacks,
      ...
      <section className="panel intro-panel">
        <div>
          <h2>Live examples</h2>
          <p>React 17 app generated as a clean Vite runtime and aligned with the Angular 21 live template.</p>
        </div>
